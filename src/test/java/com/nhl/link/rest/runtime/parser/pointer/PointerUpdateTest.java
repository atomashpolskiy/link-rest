...
public class PointerUpdateTest extends JerseyTestOnDerby {
    ...
    public void testUpdate_InstancePointer() throws Exception {
		...
		runtime.newContext().performGenericQuery(insertE4);
    ...
    public void testUpdate_ToOneRelationshipPointer_Implicit() throws Exception {
		...
		runtime.newContext().performGenericQuery(insertE2_1);
        runtime.newContext().performGenericQuery(insertE2_2);
        runtime.newContext().performGenericQuery(insertE3);

        E3 baseObject = runtime.newContext().selectOne(SelectQuery.query(E3.class, E3.NAME.eq("xxx")));
        E2 newRelatedObject = runtime.newContext().selectOne(SelectQuery.query(E2.class, E2.NAME.eq("www")));
        ...
        E3 updatedE3 = runtime.newContext().selectOne(SelectQuery.query(E3.class, E3.NAME.eq("xxx")));
        E2 oldE2 = runtime.newContext().selectOne(SelectQuery.query(E2.class, E2.NAME.eq("yyy")));
        E2 newE2 = runtime.newContext().selectOne(SelectQuery.query(E2.class, E2.NAME.eq("www")));
    ...
    public void testUpdate_ToManyRelationship_CollectionPointer() throws Exception {
        ...
        E2 baseObject = runtime.newContext().selectOne(SelectQuery.query(E2.class, E2.NAME.eq("yyy")));
        E3 newRelatedObject = runtime.newContext().selectOne(SelectQuery.query(E3.class, E3.NAME.eq("zzz")));
        ...
        E2 updatedE2 = runtime.newContext().selectOne(SelectQuery.query(E2.class, E2.NAME.eq("yyy")));
